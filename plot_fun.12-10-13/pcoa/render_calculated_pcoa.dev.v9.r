  ...
  
{
  ...
  plot_pch <- load_pch(pch_table, pch_column, num_samples, pch_default, rownames(my_data$eigen_vectors), debug) # This handles the pch if it is specified in a table # table may need 2 or more columns to work .... argh 
  ...
  ##   names(plot_pch) <- rownames(my_data$eigen_vectors)
  ##   #class(plot_pch) <- "integer"
  ##   if(debug==TRUE){
  ##     print("used default pch")
  ##     print(paste("plot_pch class: ", class(plot_pch), sep=""))
  ##     print(plot_pch)
  ##     my_pch <<- plot_pch
  ##   }
